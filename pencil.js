...
function initPencilMotions() {
      ...
      // keyframes for pencil:    name, dt, [x, y, z, squish]
    pencilMotion.addKeyFrame(new Keyframe('lying down',    0.0, [13, 0.01, -3, 110, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [13.4, 0.01, -3, 105, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.2, 0.01, -3, 108, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [13.6, 0.01, -3, 103, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.4, 0.01, -3, 106, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [13.8, 0.01, -3, 101, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.8, 0.01, -3, 102, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('pause',         0.7, [13.8, 0.01, -3, 102, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.6, 0.01, -3, 104, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [14.0, 0.01, -3, 99, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [14.1, 0.01, -3, 97, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.8, 0.01, -3, 102, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [14.1, 0.01, -3, 97, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift left',    0.1, [13.8, 0.01, -3, 102, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('shift right',   0.1, [14.1, 0.01, -3, 97, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('pause',         7.0, [14.1, 0.01, -3, 97, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('launch',        0.1, [14.1, 0.01, -3, 97, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('fly',           0.2, [14.5, 10, 0, 90, 90, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('fly',           0.7, [14, 20, -6, 90, -90, 4, 8]));
    pencilMotion.addKeyFrame(new Keyframe('land',          0.3, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('deform',        0.1, [15, 5, -11, 90, -180, 6, 5]));
    pencilMotion.addKeyFrame(new Keyframe('reform',        0.3, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('pause',         1.0, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('jump',          0.1, [14.5, 8, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('land',          0.1, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('jump',          0.1, [14.5, 8, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('land',          0.1, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('jump',          0.1, [14.5, 8, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('land',          0.1, [14.5, 7, -11, 90, -180, 5, 7]));
    ...
    pencilMotion.addKeyFrame(new Keyframe('jump',          0.1, [14.5, 8, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('land',          0.1, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('pause',         0.1, [14.5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('move forward',  0.5, [14.5, 7, 11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('move right',    0.5, [-5, 7, 11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('move backward', 0.5, [-5, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('move left',     0.5, [14, 7, -11, 90, -180, 5, 7]));
    pencilMotion.addKeyFrame(new Keyframe('pause',         1.5, [14, 7, -11, 90, -180, 5, 7]));
}
...
function updatePencil(avars) {
    ...
    var scale1 = avars[5];
    var scale2 = avars[6];
    pencil.position.set(xPosition,yPosition, zPosition);
    pencil.rotation.z = theta1*deg2rad;
    pencil.rotation.x = theta2*deg2rad;

    pencil.scale.y = scale1;
    pencil.scale.x = scale2;
    ...
    bezCps.position.set(xNew, 0, 0);

    // updatePencil_details(avars[7]);    // update the Bezier curve and pencil geometry based on control points    
}
